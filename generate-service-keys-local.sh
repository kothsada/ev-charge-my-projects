...
echo "TRUSTED_SERVICE_ISSUERS=mobile-api:mobile,ocpp-csms:ocpp,notification-api:notification,gateway-api:gateway"
...
echo "TRUSTED_SERVICE_ISSUERS=admin-api:admin,ocpp-csms:ocpp,notification-api:notification,gateway-api:gateway"
...
echo "SERVICE_NAME=notification-api"
...
echo "TRUSTED_SERVICE_PUBLIC_KEYS=[{\"iss\":\"mobile-api\",\"key\":\"${MOBILE_PUB}\"},{\"iss\":\"ocpp-csms\",\"key\":\"${OCPP_PUB}\"},{\"iss\":\"notification-api\",\"key\":\"${NOTIF_PUB}\"},{\"iss\":\"gateway-api\",\"key\":\"${GATEWAY_PUB}\"}]"
...
echo "TRUSTED_SERVICE_PUBLIC_KEYS=[{\"iss\":\"admin-api\",\"key\":\"${ADMIN_PUB}\"},{\"iss\":\"ocpp-csms\",\"key\":\"${OCPP_PUB}\"},{\"iss\":\"notification-api\",\"key\":\"${NOTIF_PUB}\"},{\"iss\":\"gateway-api\",\"key\":\"${GATEWAY_PUB}\"}]"
